<!-- 1. 헤더 배너 -->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=auto&height=220&section=header&text=Welcome%20to%20my%20Dev%20Space!&fontSize=40&animation=fadeIn" width="100%"/>
</div>
...
<!-- 2. 자기소개 -->
## 🙋‍♂️ About Me
- 👋 안녕하세요! 끊임없이 깊이를 더해가는 개발자 **서현기**입니다.
- 💻 **Role:** 개발자 & 클라우드 엔지니어 (준비 중 ☁️)
- 🎯 **Focus:** 웹 애플리케이션 개발, 백엔드 아키텍처, 클라우드 인프라 구축
- 📖 **Current Study:** 더 안정적이고 확장성 있는 시스템을 위해 클라우드 기술(AWS/Docker 등)을 독학하고 있습니다.
